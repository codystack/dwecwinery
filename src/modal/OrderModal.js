        ...
        <div className="modal fade" id="orderModal" data-bs-backdrop="static" data-bs-keyboard="false" tabIndex={-1} aria-labelledby="staticBackdropLabel" aria-hidden="true">
            ...
            <div className="modal-content">
                <div className="modal-body mt-4 text-center">
                    ...
                    <p className='mt-3 fs-xll'>Kindly note that deliveries within <span className='text-primary fw-medium'>Port Harcourt</span> metropolis are processed and delivered within the <span className='text-primary fw-medium'>hours after payment has been verified</span>.</p>
                </div>
